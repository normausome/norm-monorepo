...
describe("isSweTitle", () => {
  test.each([
    ...
    ["Développeur Logiciels (Stagiaire), Backend (l'été 2027 - Montreal)", false],
    ["Software Engineer, Ads Manager", true],
    ["Staff Software Engineer, Technical Lead, Lakebase Manager (LBM)", true],
