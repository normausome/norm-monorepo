...
const SAMPLES: Record<Seniority, string[]> = {
  ...
  mid: [
    ...
    "Desarrollador Semi-Senior Fullstack",
  ...
  senior: [
    ...
    "SRE Sênior",
    "Desarrollador Sénior Backend",
    "Snr Software Engineer",
  ],
  staff: [
    "Staff Software Engineer",
    "Staff Software Engineer, Technical Lead, Lakebase Manager (LBM)",
  ...
  manager: [
    ...
    "Forward Deployed Engineer, Manager - London",
    "Engineer Manager, HR Applications",
  ],
