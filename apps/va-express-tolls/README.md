...
3. Tap the primary button to open the operator's official calculator in a new tab. That calculator is the only source of prices.
4. Read the caveats: web estimates can differ from the gantry/sign price, E-ZPass is required, and an I-66 → I-495 trip crosses operators so it is two tolls.
